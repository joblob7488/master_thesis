...
From the results presented in the previous chapter we see that, at the scale of the MNIST model, inference time is mostly dominated by the movement of data from external DDR2 memory to internal DMEM, rather than by computing clause evaluation itself. This section examines this result.
