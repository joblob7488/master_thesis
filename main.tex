...
\noindent \textbf{\Large Processor-level Accleration of Tsetlin \\ Machines Using Custom RISC-V \\ISA Extensions} \\
\vspace{0.5cm}
...
\input{Chapters/01Introduction/0IntroductionHeader}
...
\chapter{Theory}
\input{Chapters/02Theory/0TheoryHeader}



\chapter{Methods}
\input{Chapters/03Method/0MethodHeader}



\chapter{Results}
\input{Chapters/04Results/0ResultsHeader}



\chapter{Discussion}
\input{Chapters/05Discussion/0DiscussionHeader}



\chapter{Conclusions}
\input{Chapters/06Conclusion/0ConclusionHeader}



\chapter*{AI Declaration}
\input{Chapters/AIDeclaration}
